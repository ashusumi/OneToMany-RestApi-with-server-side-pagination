...
import com.example.test.service.CatePageServiceImpl;
...
public class CategoryController {
	@Autowired
	private CatePageServiceImpl catPage;
	...
	public List<Category> getPaginatedCategory(@PathVariable int pageNo,@PathVariable int pageSize){
		return  catPage.findBycategoryWithPage(pageNo, pageSize);
	}
