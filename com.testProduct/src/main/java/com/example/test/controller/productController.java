...
import com.example.test.service.productPageServiceImpl;
...
public class productController {
	...
	@Autowired
	productPageServiceImpl pageService;
	...
	public List<Product> getPaginatedProduct(@PathVariable int pageNo,@PathVariable int pageSize){
		
		return  pageService.findProductByPage(pageNo, pageSize);
	}
